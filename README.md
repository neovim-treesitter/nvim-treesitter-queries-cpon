# nvim-treesitter-queries-cpon

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-cpon/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-cpon/actions/workflows/validate.yml)

Neovim tree-sitter queries for **cpon**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-cpon",
...
- [ ] Changes are scoped to `cpon` — do not include files for other languages
